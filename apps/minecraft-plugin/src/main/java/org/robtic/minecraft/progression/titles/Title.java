...
import org.robtic.minecraft.progression.api.Rarity;
import org.robtic.minecraft.progression.api.TitleSource;
import org.robtic.minecraft.progression.api.UnlockCondition;
...
public record Title(
    ...
    public Component name() {
        return org.robtic.minecraft.util.Chat.component(display).colorIfAbsent(color);
    }
