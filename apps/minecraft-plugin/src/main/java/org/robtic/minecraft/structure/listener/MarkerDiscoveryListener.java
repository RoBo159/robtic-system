package org.robtic.minecraft.structure.listener;
...
public final class MarkerDiscoveryListener implements Listener {
    ...
    private final org.robtic.minecraft.structure.item.MarkerItemFactory items;
    private final Supplier<MarkerSettings> settings;

    public MarkerDiscoveryListener(
            Plugin plugin,
            StructureMarkerSystem system,
            org.robtic.minecraft.structure.item.MarkerItemFactory items,
