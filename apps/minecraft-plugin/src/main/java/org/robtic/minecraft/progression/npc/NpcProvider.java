 ...
 *
 * <pre>
 *   FancyNpcsProvider   preferred when installed — packet NPCs, no real entities, no mob cap
 ...
 * neither still gets working recruiters and sellers; a server that later installs FancyNPCs gets
...
public interface NpcProvider {
     ...
     *
     * FancyNPCs has no entity to click — its NPCs are packets — so its implementation always returns
     ...
     *
     * A callback rather than each provider raising a Bukkit event, because FancyNPCs delivers clicks
