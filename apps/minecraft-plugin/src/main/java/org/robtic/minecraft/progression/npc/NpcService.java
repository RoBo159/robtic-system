 ...
 * FancyNPCs and the builtin implementation. Nothing above this line knows which of the three is
 * running.
 *
...
public final class NpcService {
    ...
    /** Resolves a clicked entity. Always empty under FancyNPCs — see {@link NpcProvider#identify}. */
