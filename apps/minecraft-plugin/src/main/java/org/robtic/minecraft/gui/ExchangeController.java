        ...
        scheduler.runTaskAsynchronously(plugin, () -> {
            try {
                ...
                scheduler.runTask(plugin, () -> {
                    ...
                    player.sendMessage(messages.prefixed("robs.sale-complete", "robs", org.robtic.minecraft.util.Robs.format(credited)));
                    player.sendMessage(messages.prefixed("robs.balance", "robs", org.robtic.minecraft.util.Robs.format(balance)));
                });
