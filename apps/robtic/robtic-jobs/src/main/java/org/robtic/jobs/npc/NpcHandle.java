 ...
 *   builtin     the entity's UUID, which changes if the entity is respawned
 * </pre>
 *
 * Storing a bare UUID would therefore tie this to one backend and would silently break if an
